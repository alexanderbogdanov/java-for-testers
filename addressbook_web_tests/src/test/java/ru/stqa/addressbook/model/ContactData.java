...
public record ContactData(String firstName, String lastName, String address, String homePhone, String mobilePhone,
    ...
    public ContactData withHomePhone(String homePhone) {
        return new ContactData(this.firstName, this.lastName, this.address, homePhone, this.mobilePhone, this.workPhone, this.email, this.email2, this.email3);
    }
    ...
    public ContactData withWorkPhone(String workPhone) {
        return new ContactData(this.firstName, this.lastName, this.address, this.homePhone, this.mobilePhone, workPhone, this.email, this.email2, this.email3);
    }
    ...
    public ContactData withEmail2(String email2) {
        return new ContactData(this.firstName, this.lastName, this.address, this.homePhone, this.mobilePhone, this.workPhone, this.email, email2, this.email3);
    }

    public ContactData withEmail3(String email3) {
        return new ContactData(this.firstName, this.lastName, this.address, this.homePhone, this.mobilePhone, this.workPhone, this.email, this.email2, email3);
    }
}
